		...
		<div id="content">
			<div class="row">
				<div class="col-sm-9">
					...
					<div class="row">
						<div class="col-sm-4">
							<img src="source/image/product/{{$sanpham->image}}" height="250px" alt="">
						</div>
						<div class="col-sm-8">
							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="{{route('chitietsanpham',$tuongtu->id)}}"><img src="source/image/product/{{$tuongtu->image}}" height="250px" alt=""></a>
									</div>
									<div class="single-item-body">
										<p class="single-item-title">{{$tuongtu->name}}</p>
										<p class="single-item-price">
											@if($tuongtu->promotion_price == 0)
											<span class="flash-del">{{number_format($tuongtu->unit_price)}} VNĐ</span>
											@else
											<span class="flash-del">{{number_format($tuongtu->unit_price)}} VNĐ</span>
											<span class="flash-sale">{{number_format($tuongtu->promotion_price)}} VNĐ</span>
											@endif
										</p>
									</div>
